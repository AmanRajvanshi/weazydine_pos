      ...
      <>
        <div className="main-wrapper">
          ...
          <div className="content">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="form-group">
                        ...
                        <select value={this.state.c_id}  onChange={(e)=>{this.setState(
                        {c_id:e.target.value}
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="form-group">
                        ...
                        <input type="text" value={this.state.market_price}  onChange={(e)=>{this.setState(
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="form-group">
                        ...
                        <input value={this.state.our_price}  onChange={(e)=>{this.setState(
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        ...
                        <RadioGroup value={this.state.is_veg} onChange={(e)=>{this.setState({is_veg:e})}} horizontal>
                          <RadioButton
                            value="1"
                            pointColor="#f3c783"
                            iconSize={20}
                    ...
                    <div className="col-lg-12">
                      <div className="form-group">
                        ...
                        <textarea  value={this.state.description}  onChange={(e)=>{this.setState(
           ...
           <Variants product_id={this.state.product_id} navigate={this.props.navigate} variants={this.state.v_data} addons={this.state.addon} update_child={this.update_variant_from_child} />
                                  ...
                                  <tr id="addr0" key={idx}>
                                    ...
                                    <td>
                                      <input
                                        ...
                                        name="variants_price"
                                        value={
                                          this.state.rows[idx].variants_price
                                        }
                                        onChange={this.handleChange(idx)}
                                        className="form-control"
                                      />
                                    ...
                                    <td>
                                      <input
                                        ...
                                        value={this.state.rows[idx].variants_discounted_price}
                                        onChange={this.handleChange(idx)}
                                        className="form-control"
                                      />
                                    </td>
